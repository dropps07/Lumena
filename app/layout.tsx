import "./globals.css";
import { onest, chillax, clashDisplay } from "@/lib/fonts";
...
export const metadata = {
  title: "Lumena - Generate Beautiful Gradients",
  description:
  ...
  metadataBase: new URL("https://Lumena.vercel.app"),
  keywords: [
    // Core Features
    "gradient generator",
    "gradient maker",
  ...
  alternates: {
    canonical: "https://Lumena.fun",
  },
  category: "Design Tools",
  applicationName: "Lumena",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Press+Start+2P:wght@400;700&display=swap"
          rel="stylesheet"
        />
        <script
          defer
        ...
        />
        <meta name="apple-mobile-web-app-title" content="Lumena" />
      ...
      <body
        className={`${onest.variable} ${chillax.variable} ${clashDisplay.variable} antialiased min-h-screen bg-background`}
      >
        <Analytics />
        <ThemeProvider
          attribute="class"
